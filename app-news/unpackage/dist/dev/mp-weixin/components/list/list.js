...
/***/ 81:
/*!**************************************************************************************************!*\
  !*** /usr/local/mydata/mycode/uni-app-demo/uniapp-demo-github/app-news/components/list/list.vue ***!
  \**************************************************************************************************/
...
/***/ 82:
/*!*********************************************************************************************************************************!*\
  !*** /usr/local/mydata/mycode/uni-app-demo/uniapp-demo-github/app-news/components/list/list.vue?vue&type=template&id=48015944& ***!
  \*********************************************************************************************************************************/
...
/***/ 84:
/*!***************************************************************************************************************************!*\
  !*** /usr/local/mydata/mycode/uni-app-demo/uniapp-demo-github/app-news/components/list/list.vue?vue&type=script&lang=js& ***!
  \***************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...

{
  ...
  methods: {
    ...
    getList: function getList(current) {var _this = this;
      ...
      // TODO，不合理
      var name = this.tabList[current] && this.tabList[current].name ? this.tabList[current].name : '全部';
      ...
      then(function (res) {var
        ...
        console.log('tab', _this.tabList[current].name);
        var tmpList = _this.list[current] || [];
        tmpList.push.apply(tmpList, _toConsumableArray(data));
        _this.$set(_this.list, current, tmpList);
...
/***/ 86:
/*!************************************************************************************************************************************!*\
  !*** /usr/local/mydata/mycode/uni-app-demo/uniapp-demo-github/app-news/components/list/list.vue?vue&type=style&index=0&lang=scss& ***!
  \************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
